...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	userOnboardingAttributeService := handler.ProvideUserOnboardingAttributeService(userAttributeService)
	userHandler := handler.NewUserHandler(userService, authService, emailService, emailCache, affiliateService, userOnboardingAttributeService)
	...
	groupBuyService := service.NewGroupBuyService(db, userSubscriptionRepository, billingCacheService)
	groupBuyHandler := handler.NewGroupBuyHandler(groupBuyService)
	...
	publicChannelStatusService := service.ProvidePublicChannelStatusService(scheduledTestPlanRepository, scheduledTestResultRepository)
	channelMonitorUserHandler := handler.NewChannelMonitorUserHandler(channelMonitorService, publicChannelStatusService, settingService)
	...
	openAIGatewayService := service.NewOpenAIGatewayService(accountRepository, usageLogRepository, usageBillingRepository, userRepository, userSubscriptionRepository, userGroupRateRepository, gatewayCache, configConfig, schedulerSnapshotService, concurrencyService, billingService, rateLimitService, billingCacheService, httpUpstream, deferredService, openAITokenProvider, modelPricingResolver, channelService, balanceNotifyService, settingService, scheduledTestResultRepository)
	...
	scheduledTestRunnerService := service.ProvideScheduledTestRunnerService(scheduledTestPlanRepository, scheduledTestService, publicChannelStatusService, accountTestService, rateLimitService, configConfig)

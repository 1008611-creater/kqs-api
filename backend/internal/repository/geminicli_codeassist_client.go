...
func (c *geminiCliCodeAssistClient) LoadCodeAssist(ctx context.Context, accessToken, proxyURL string, reqBody *geminicli.LoadCodeAssistRequest) (*geminicli.LoadCodeAssistResponse, error) {
	...
	fmt.Printf("[CodeAssist] LoadCodeAssist success: status %d cloudaicompanion_project_present=%t\n", resp.StatusCode, out.CloudAICompanionProject != "")
	return &out, nil
}
...
func (c *geminiCliCodeAssistClient) OnboardUser(ctx context.Context, accessToken, proxyURL string, reqBody *geminicli.OnboardUserRequest) (*geminicli.OnboardUserResponse, error) {
	...
	fmt.Printf("[CodeAssist] OnboardUser request: tier_present=%t metadata_present=%t\n", reqBody.TierID != "", reqBody.Metadata.IDEType != "" || reqBody.Metadata.Platform != "" || reqBody.Metadata.PluginType != "")
	...
	fmt.Printf("[CodeAssist] OnboardUser success: status %d cloudaicompanion_project_present=%t\n", resp.StatusCode, out.Response != nil && out.Response.CloudAICompanionProject != nil)
	return &out, nil
}

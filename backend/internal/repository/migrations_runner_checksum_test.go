...
func TestIsMigrationChecksumCompatible(t *testing.T) {
	...
	t.Run("142预发布默认配置历史checksum可兼容", func(t *testing.T) {
		ok := isMigrationChecksumCompatible(
			"142_cau_prelaunch_defaults.sql",
			"b0b427baed97b423be97d425533866526b064948d8d7115cf11212b911febc96",
			"5d2be9025c4b3d8f726dcaae924b69110ff143d0cb0017f801b397002572d80f",
		)
		require.True(t, ok)
	})

	t.Run("152订阅套餐历史checksum可兼容", func(t *testing.T) {
		ok := isMigrationChecksumCompatible(
			"152_seed_cau_daily_subscription_plans.sql",
			"3503cef700451a56cb63c1278148f8b7a00bffa35aa426a3d8457019002bc628",
			"e443fa05fc9d760907611e0ff66973269c83bb0e6e4793c5692c89904bede238",
		)
		require.True(t, ok)
	})
}

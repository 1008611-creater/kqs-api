...
func cauLegalLoginAgreementDocumentsJSON() string {
	docs := []service.LoginAgreementDocument{
		{
			ID:    "terms",
			Title: "服务条款",
			ContentMD: `# 服务条款
...
func TestAPIContracts(t *testing.T) {
	...
	tests := []struct {
				...
				"data": [
					{
						...
						"daily_rollover_usd": 0,
						"quota_bonus_multiplier": 0,
		...
		},
		{
			...
			}`, cauLegalLoginAgreementDocumentsJSON()),
		},
		{
...
func (stubUserSubscriptionRepo) ResetDailyUsage(ctx context.Context, id int64, newWindowStart time.Time, rolloverUSD float64) error {
	return errors.New("not implemented")
}

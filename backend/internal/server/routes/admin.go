...
func registerOpsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	ops := admin.Group("/ops")
	{
		...
		ops.GET("/account-routing", h.Admin.Ops.GetAccountRoutingStats)
		...
		{
			settings.GET("/url-allowlist", h.Admin.Ops.GetURLAllowlistSettings)
			settings.PUT("/url-allowlist", h.Admin.Ops.UpdateURLAllowlistSettings)
		...
		ops.GET("/dashboard/upstream-traffic", h.Admin.Ops.GetDashboardUpstreamTraffic)
		ops.GET("/dashboard/proxy-traffic-pools", h.Admin.Ops.GetDashboardProxyTrafficPools)
	}
}
...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.POST("/speed-test", h.Admin.Account.SpeedTest)
		accounts.PUT("/:id/group-priority", h.Admin.Account.UpdateGroupPriority)

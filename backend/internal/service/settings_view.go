...
// OpenAIVIPFastModeSettings controls server-side opt-in for OpenAI priority
// service tier. It is deliberately target-based: enabling the switch without
// user/key/group targets must not turn priority mode on for every customer.
...
func DefaultOpenAIVIPFastModeSettings() *OpenAIVIPFastModeSettings {
	return &OpenAIVIPFastModeSettings{
		Enabled:                  false,
		UserIDs:                  []int64{},
		APIKeyIDs:                []int64{},
		GroupIDs:                 []int64{},

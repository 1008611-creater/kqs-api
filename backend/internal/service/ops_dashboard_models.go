...
type OpsUpstreamTrafficTrendPoint struct {
...
type OpsUpstreamTrafficAccountItem struct {
...
type OpsUpstreamTrafficStatsResponse struct {
	StartTime time.Time `json:"start_time"`
	EndTime   time.Time `json:"end_time"`
	Platform  string    `json:"platform"`
	GroupID   *int64    `json:"group_id"`
	...
	Trend       []*OpsUpstreamTrafficTrendPoint  `json:"trend"`
	TopAccounts []*OpsUpstreamTrafficAccountItem `json:"top_accounts"`
}

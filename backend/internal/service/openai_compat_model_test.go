...
func TestForwardAsAnthropic_VIPFastModePropagatesFinalServiceTier(t *testing.T) {
	...
	upstream := &httpUpstreamRecorder{resp: &http.Response{
		...
		Header:     http.Header{"Content-Type": []string{"text/event-stream"}, "x-request-id": []string{"rid_messages_vip_tier"}},
	...
	result, err := svc.ForwardAsAnthropic(openAIVIPFastModeTestContext(), c, account, body, "", "gpt-5.1")

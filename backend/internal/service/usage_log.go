...
type UsageLog struct {
	...
	// UpstreamRequestBytes / UpstreamResponseBytes record bytes sent to and received from upstream.
	// They are admin-only traffic analytics fields, not user-facing quota fields.

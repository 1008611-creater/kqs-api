...
func (m *opsRepoMock) GetUpstreamTrafficStats(ctx context.Context, filter *OpsDashboardFilter, bucketSeconds int) (*OpsUpstreamTrafficStatsResponse, error) {
	return &OpsUpstreamTrafficStatsResponse{}, nil
}

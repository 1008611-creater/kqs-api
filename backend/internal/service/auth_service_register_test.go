...
func TestAuthService_Register_CauEmailVerifyRequiredWhenGlobalEmailVerifyDisabled(t *testing.T) {
	repo := &userRepoStub{}
...
func TestAuthService_Register_CauEmailVerifyInvalidWhenGlobalEmailVerifyDisabled(t *testing.T) {
	repo := &userRepoStub{}
	cache := &emailCacheStub{
...
func TestAuthService_Register_NonCauEmailDoesNotRequireVerifyWhenGlobalEmailVerifyDisabled(t *testing.T) {
...
func TestAuthService_Register_InvitationCodeRequiredWhenEnabled(t *testing.T) {
	repo := &userRepoStub{}
	service := newAuthService(repo, map[string]string{
		SettingKeyRegistrationEnabled:   "true",
...
func TestAuthService_Register_InvitationCodeEnabledRequiresRedeemRepository(t *testing.T) {
	repo := &userRepoStub{}
	service := newAuthService(repo, map[string]string{
		SettingKeyRegistrationEnabled:   "true",
		SettingKeyInvitationCodeEnabled: "true",
	...
	_, _, err := service.RegisterWithVerification(context.Background(), "user@test.com", "password", "", "", "INVITE123", "")
	require.ErrorIs(t, err, ErrServiceUnavailable)
	require.Empty(t, repo.created)
}

...
func (s *PaymentService) doSub(ctx context.Context, o *dbent.PaymentOrder) error {
	...
	_, err = s.subscriptionSvc.AssignIndependentSubscription(ctx, &AssignSubscriptionInput{UserID: o.UserID, GroupID: gid, ValidityDays: days, AssignedBy: 0, Notes: orderNote})
	if err != nil {

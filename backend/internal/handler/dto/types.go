...
type Group struct {
	...
	// SupportedModelScopes exposes non-sensitive group capability flags to user-facing clients.
	// For OpenAI groups, codex_all_models enables the Codex GPT+domestic model import guide.
...
type UserSubscription struct {
	...
	DailyRolloverUSD  float64  `json:"daily_rollover_usd"`
	DailyAvailableUSD *float64 `json:"daily_available_usd,omitempty"`
	...
	QuotaBonusMultiplier    float64  `json:"quota_bonus_multiplier"`
	QuotaBonusSource        string   `json:"quota_bonus_source,omitempty"`

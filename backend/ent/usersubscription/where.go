...
// DailyRolloverUsd applies equality check predicate on the "daily_rollover_usd" field. It's identical to DailyRolloverUsdEQ.
func DailyRolloverUsd(v float64) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldEQ(FieldDailyRolloverUsd, v))
}
...
// QuotaBonusMultiplier applies equality check predicate on the "quota_bonus_multiplier" field. It's identical to QuotaBonusMultiplierEQ.
func QuotaBonusMultiplier(v float64) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldEQ(FieldQuotaBonusMultiplier, v))
}

// QuotaBonusSource applies equality check predicate on the "quota_bonus_source" field. It's identical to QuotaBonusSourceEQ.
func QuotaBonusSource(v string) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldEQ(FieldQuotaBonusSource, v))
}
...
// DailyRolloverUsdEQ applies the EQ predicate on the "daily_rollover_usd" field.
func DailyRolloverUsdEQ(v float64) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldEQ(FieldDailyRolloverUsd, v))
}

// DailyRolloverUsdNEQ applies the NEQ predicate on the "daily_rollover_usd" field.
func DailyRolloverUsdNEQ(v float64) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldNEQ(FieldDailyRolloverUsd, v))
}

// DailyRolloverUsdIn applies the In predicate on the "daily_rollover_usd" field.
func DailyRolloverUsdIn(vs ...float64) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldIn(FieldDailyRolloverUsd, vs...))
}

// DailyRolloverUsdNotIn applies the NotIn predicate on the "daily_rollover_usd" field.
func DailyRolloverUsdNotIn(vs ...float64) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldNotIn(FieldDailyRolloverUsd, vs...))
}

// DailyRolloverUsdGT applies the GT predicate on the "daily_rollover_usd" field.
func DailyRolloverUsdGT(v float64) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldGT(FieldDailyRolloverUsd, v))
}

// DailyRolloverUsdGTE applies the GTE predicate on the "daily_rollover_usd" field.
func DailyRolloverUsdGTE(v float64) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldGTE(FieldDailyRolloverUsd, v))
}

// DailyRolloverUsdLT applies the LT predicate on the "daily_rollover_usd" field.
func DailyRolloverUsdLT(v float64) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldLT(FieldDailyRolloverUsd, v))
}

// DailyRolloverUsdLTE applies the LTE predicate on the "daily_rollover_usd" field.
func DailyRolloverUsdLTE(v float64) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldLTE(FieldDailyRolloverUsd, v))
}
...
// QuotaBonusMultiplierEQ applies the EQ predicate on the "quota_bonus_multiplier" field.
func QuotaBonusMultiplierEQ(v float64) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldEQ(FieldQuotaBonusMultiplier, v))
}

// QuotaBonusMultiplierNEQ applies the NEQ predicate on the "quota_bonus_multiplier" field.
func QuotaBonusMultiplierNEQ(v float64) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldNEQ(FieldQuotaBonusMultiplier, v))
}

// QuotaBonusMultiplierIn applies the In predicate on the "quota_bonus_multiplier" field.
func QuotaBonusMultiplierIn(vs ...float64) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldIn(FieldQuotaBonusMultiplier, vs...))
}

// QuotaBonusMultiplierNotIn applies the NotIn predicate on the "quota_bonus_multiplier" field.
func QuotaBonusMultiplierNotIn(vs ...float64) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldNotIn(FieldQuotaBonusMultiplier, vs...))
}

// QuotaBonusMultiplierGT applies the GT predicate on the "quota_bonus_multiplier" field.
func QuotaBonusMultiplierGT(v float64) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldGT(FieldQuotaBonusMultiplier, v))
}

// QuotaBonusMultiplierGTE applies the GTE predicate on the "quota_bonus_multiplier" field.
func QuotaBonusMultiplierGTE(v float64) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldGTE(FieldQuotaBonusMultiplier, v))
}

// QuotaBonusMultiplierLT applies the LT predicate on the "quota_bonus_multiplier" field.
func QuotaBonusMultiplierLT(v float64) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldLT(FieldQuotaBonusMultiplier, v))
}

// QuotaBonusMultiplierLTE applies the LTE predicate on the "quota_bonus_multiplier" field.
func QuotaBonusMultiplierLTE(v float64) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldLTE(FieldQuotaBonusMultiplier, v))
}

// QuotaBonusSourceEQ applies the EQ predicate on the "quota_bonus_source" field.
func QuotaBonusSourceEQ(v string) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldEQ(FieldQuotaBonusSource, v))
}

// QuotaBonusSourceNEQ applies the NEQ predicate on the "quota_bonus_source" field.
func QuotaBonusSourceNEQ(v string) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldNEQ(FieldQuotaBonusSource, v))
}

// QuotaBonusSourceIn applies the In predicate on the "quota_bonus_source" field.
func QuotaBonusSourceIn(vs ...string) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldIn(FieldQuotaBonusSource, vs...))
}

// QuotaBonusSourceNotIn applies the NotIn predicate on the "quota_bonus_source" field.
func QuotaBonusSourceNotIn(vs ...string) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldNotIn(FieldQuotaBonusSource, vs...))
}

// QuotaBonusSourceGT applies the GT predicate on the "quota_bonus_source" field.
func QuotaBonusSourceGT(v string) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldGT(FieldQuotaBonusSource, v))
}

// QuotaBonusSourceGTE applies the GTE predicate on the "quota_bonus_source" field.
func QuotaBonusSourceGTE(v string) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldGTE(FieldQuotaBonusSource, v))
}

// QuotaBonusSourceLT applies the LT predicate on the "quota_bonus_source" field.
func QuotaBonusSourceLT(v string) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldLT(FieldQuotaBonusSource, v))
}

// QuotaBonusSourceLTE applies the LTE predicate on the "quota_bonus_source" field.
func QuotaBonusSourceLTE(v string) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldLTE(FieldQuotaBonusSource, v))
}

// QuotaBonusSourceContains applies the Contains predicate on the "quota_bonus_source" field.
func QuotaBonusSourceContains(v string) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldContains(FieldQuotaBonusSource, v))
}

// QuotaBonusSourceHasPrefix applies the HasPrefix predicate on the "quota_bonus_source" field.
func QuotaBonusSourceHasPrefix(v string) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldHasPrefix(FieldQuotaBonusSource, v))
}

// QuotaBonusSourceHasSuffix applies the HasSuffix predicate on the "quota_bonus_source" field.
func QuotaBonusSourceHasSuffix(v string) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldHasSuffix(FieldQuotaBonusSource, v))
}

// QuotaBonusSourceIsNil applies the IsNil predicate on the "quota_bonus_source" field.
func QuotaBonusSourceIsNil() predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldIsNull(FieldQuotaBonusSource))
}

// QuotaBonusSourceNotNil applies the NotNil predicate on the "quota_bonus_source" field.
func QuotaBonusSourceNotNil() predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldNotNull(FieldQuotaBonusSource))
}

// QuotaBonusSourceEqualFold applies the EqualFold predicate on the "quota_bonus_source" field.
func QuotaBonusSourceEqualFold(v string) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldEqualFold(FieldQuotaBonusSource, v))
}

// QuotaBonusSourceContainsFold applies the ContainsFold predicate on the "quota_bonus_source" field.
func QuotaBonusSourceContainsFold(v string) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldContainsFold(FieldQuotaBonusSource, v))
}

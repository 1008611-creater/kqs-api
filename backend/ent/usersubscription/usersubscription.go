...
const (
	...
	// FieldDailyRolloverUsd holds the string denoting the daily_rollover_usd field in the database.
	FieldDailyRolloverUsd = "daily_rollover_usd"
	...
	// FieldQuotaBonusMultiplier holds the string denoting the quota_bonus_multiplier field in the database.
	FieldQuotaBonusMultiplier = "quota_bonus_multiplier"
	// FieldQuotaBonusSource holds the string denoting the quota_bonus_source field in the database.
	FieldQuotaBonusSource = "quota_bonus_source"
...
var (
	...
	// DefaultDailyRolloverUsd holds the default value on creation for the "daily_rollover_usd" field.
	DefaultDailyRolloverUsd float64
	...
	// DefaultQuotaBonusMultiplier holds the default value on creation for the "quota_bonus_multiplier" field.
	DefaultQuotaBonusMultiplier float64
...
// ByDailyRolloverUsd orders the results by the daily_rollover_usd field.
func ByDailyRolloverUsd(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldDailyRolloverUsd, opts...).ToFunc()
}
...
// ByQuotaBonusMultiplier orders the results by the quota_bonus_multiplier field.
func ByQuotaBonusMultiplier(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldQuotaBonusMultiplier, opts...).ToFunc()
}

// ByQuotaBonusSource orders the results by the quota_bonus_source field.
func ByQuotaBonusSource(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldQuotaBonusSource, opts...).ToFunc()
}

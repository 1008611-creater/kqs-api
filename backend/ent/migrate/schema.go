...
var (
	...
	UserSubscriptionsColumns = []*schema.Column{
		...
		{Name: "expires_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "status", Type: field.TypeString, Size: 20, Default: "active"},
		{Name: "validity_days", Type: field.TypeInt, Default: 1},
		...
		{Name: "daily_rollover_usd", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		...
		{Name: "daily_limit_override_usd", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "weekly_limit_override_usd", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "monthly_limit_override_usd", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "quota_bonus_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "quota_bonus_source", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},

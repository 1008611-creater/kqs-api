...
type UserSubscription struct {
	...
	// DailyRolloverUsd holds the value of the "daily_rollover_usd" field.
	DailyRolloverUsd float64 `json:"daily_rollover_usd,omitempty"`
	...
	// QuotaBonusMultiplier holds the value of the "quota_bonus_multiplier" field.
	QuotaBonusMultiplier float64 `json:"quota_bonus_multiplier,omitempty"`
	// QuotaBonusSource holds the value of the "quota_bonus_source" field.
...
func (*UserSubscription) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case usersubscription.FieldDailyUsageUsd, usersubscription.FieldDailyRolloverUsd, usersubscription.FieldWeeklyUsageUsd, usersubscription.FieldMonthlyUsageUsd, usersubscription.FieldDailyLimitOverrideUsd, usersubscription.FieldWeeklyLimitOverrideUsd, usersubscription.FieldMonthlyLimitOverrideUsd, usersubscription.FieldQuotaBonusMultiplier:
		...
		case usersubscription.FieldStatus, usersubscription.FieldQuotaBonusSource, usersubscription.FieldNotes:
...
func (_m *UserSubscription) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case usersubscription.FieldDailyRolloverUsd:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field daily_rollover_usd", values[i])
			} else if value.Valid {
				_m.DailyRolloverUsd = value.Float64
			}
		...
		case usersubscription.FieldQuotaBonusMultiplier:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field quota_bonus_multiplier", values[i])
			} else if value.Valid {
				_m.QuotaBonusMultiplier = value.Float64
			}
		case usersubscription.FieldQuotaBonusSource:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field quota_bonus_source", values[i])
			} else if value.Valid {
				_m.QuotaBonusSource = new(string)
				*_m.QuotaBonusSource = value.String
			}
...
func (_m *UserSubscription) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("daily_rollover_usd=")
	builder.WriteString(fmt.Sprintf("%v", _m.DailyRolloverUsd))
	builder.WriteString(", ")
	...
	builder.WriteString(", ")
	builder.WriteString("quota_bonus_multiplier=")
	builder.WriteString(fmt.Sprintf("%v", _m.QuotaBonusMultiplier))
	builder.WriteString(", ")
	if v := _m.QuotaBonusSource; v != nil {
		builder.WriteString("quota_bonus_source=")

...
func init() {
	...
	// usersubscriptionDescValidityDays is the schema descriptor for validity_days field.
	usersubscriptionDescValidityDays := usersubscriptionFields[5].Descriptor()
	// usersubscription.DefaultValidityDays holds the default value on creation for the validity_days field.
	usersubscription.DefaultValidityDays = usersubscriptionDescValidityDays.Default.(int)
	...
	// usersubscriptionDescDailyRolloverUsd is the schema descriptor for daily_rollover_usd field.
	usersubscriptionDescDailyRolloverUsd := usersubscriptionFields[10].Descriptor()
	// usersubscription.DefaultDailyRolloverUsd holds the default value on creation for the daily_rollover_usd field.
	usersubscription.DefaultDailyRolloverUsd = usersubscriptionDescDailyRolloverUsd.Default.(float64)
	...
	// usersubscriptionDescQuotaBonusMultiplier is the schema descriptor for quota_bonus_multiplier field.
	usersubscriptionDescQuotaBonusMultiplier := usersubscriptionFields[16].Descriptor()
	// usersubscription.DefaultQuotaBonusMultiplier holds the default value on creation for the quota_bonus_multiplier field.
	usersubscription.DefaultQuotaBonusMultiplier = usersubscriptionDescQuotaBonusMultiplier.Default.(float64)

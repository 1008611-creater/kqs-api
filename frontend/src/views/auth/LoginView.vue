    ...
    <div class="space-y-6">
      ...
      <form @submit.prevent="handleLogin" class="space-y-5">
        ...
        <button
          ...
          class="btn btn-primary w-full min-h-12 rounded-xl shadow-lg shadow-primary-900/10"
        >
          <svg
            v-if="isLoading"
        ...
        <div v-if="showOAuthLogin" class="space-y-3 pt-1">
          <div class="flex items-center gap-3">
            <div class="h-px flex-1 bg-primary-900/10 dark:bg-white/10"></div>
            <span class="text-xs text-primary-900/48 dark:text-white/48">
...
const authFormDisabled = computed(() => isLoading.value)

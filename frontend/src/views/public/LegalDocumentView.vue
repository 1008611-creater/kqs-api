    ...
    <header class="border-b border-gray-200 bg-white/95 dark:border-dark-800 dark:bg-dark-900/95">
      <div class="mx-auto flex max-w-5xl items-center justify-between gap-4 px-4 py-4 sm:px-6">
        <RouterLink to="/home" class="flex min-w-0 items-center gap-3">
          <BrandLogo :src="siteLogo || defaultLogo" alt="Logo" variant="compact" />
...
const documents = computed(() => resolveKqsLegalDocuments(settings.value?.login_agreement_documents))
const siteName = computed(() => settings.value?.site_name || '矿泉水API')

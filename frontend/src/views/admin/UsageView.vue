  ...
  <AppLayout>
    <div class="space-y-6">
      ...
      <div class="space-y-4">
        ...
        <UserUsageTrendChart :user-trend-data="userTrendData" :loading="chartsLoading" />
      </div>
...
import ModelDistributionChart from '@/components/charts/ModelDistributionChart.vue'; import GroupDistributionChart from '@/components/charts/GroupDistributionChart.vue'; import TokenUsageTrend from '@/components/charts/TokenUsageTrend.vue'; import UserUsageTrendChart from '@/components/charts/UserUsageTrendChart.vue'
import EndpointDistributionChart from '@/components/charts/EndpointDistributionChart.vue'
import Icon from '@/components/icons/Icon.vue'
import type { AdminUsageLog, TrendDataPoint, UserUsageTrendPoint, ModelStat, GroupStat, EndpointStat, AdminUser } from '@/types'; import type { AdminUsageStatsResponse, AdminUsageQueryParams } from '@/api/admin/usage'
...
const trendData = ref<TrendDataPoint[]>([]); const userTrendData = ref<UserUsageTrendPoint[]>([]); const requestedModelStats = ref<ModelStat[]>([]); const upstreamModelStats = ref<ModelStat[]>([]); const mappingModelStats = ref<ModelStat[]>([]); const groupStats = ref<GroupStat[]>([]); const chartsLoading = ref(false); const modelStatsLoading = ref(false); const granularity = ref<'day' | 'hour'>('hour')
...
const loadChartData = async () => {
  ...
  try {
    ...
    userTrendData.value = snapshot.users_trend || []

        ...
        >
          ...
          <template #cell-source="{ row }">
            <div class="max-w-[240px]">
              ...
              <p v-if="row.assigned_at" class="mt-0.5 text-xs text-gray-400 dark:text-dark-400">
    ...
    >
      ...
      >
        ...
        <div>
          ...
          <textarea
            v-model.trim="assignForm.notes"
            class="input min-h-20 resize-y"
            :placeholder="t('admin.subscriptions.notesHint')"
          ></textarea>
          <p class="input-hint">{{ t('admin.subscriptions.notesHint') }}</p>
        </div>
      </form>
      <template #footer>
...
const allColumns = computed<Column[]>(() => [
  ...
  { key: 'created_at', label: t('admin.subscriptions.columns.created'), sortable: true },

  ...
  admin: {
    ...
    accounts: {
      ...
      supplyControl: {
        ...
        description: 'Lower priority values are used first; higher weights receive more traffic. Put low-cost relays early with small weights, and keep Plus/OAuth accounts as stable fallback.',

export default {
  ...
  home: {
    ...
    eyebrow: 'AI access built for learning and collaboration',
    // User-focused value proposition
    heroSubtitle: 'One Key, All AI Models',
    heroDescription: 'No need to manage multiple subscriptions. Access Claude, GPT, Gemini and more with a single API key',
    tags: {
      subscriptionToApi: 'Create Key',
      stickySession: 'Choose Model',
      realtimeBilling: 'Review Usage'
    },
    terminal: {
      routing: 'Selecting an available route...'
    },
    flow: {
      label: 'OPENAI-COMPATIBLE ACCESS',
      title: 'One key connects the models you use'
    },
    // Pain points section
    painPoints: {
    ...
    providers: {
      title: 'Call leading models through one API',
      description: 'Use one configured interface across supported models, without separate setup for every team member.',
      supported: 'Supported',
      soon: 'Soon',
      claude: 'Claude',
      gemini: 'Gemini',
    ...
    authShell: {
      kicker: 'KQS API SERVICE',
      title: 'A campus AI gateway for students and teams',
      description: 'Manage keys, model routing, and usage in one place while keeping Claude, GPT, Gemini, and other routes under control.',
      proof: {
        keysTitle: 'Keys and groups',
        keysDesc: 'Separate members, course projects, and quota limits.',
        routingTitle: 'Pool routing',
        routingDesc: 'Dispatch across upstream accounts with automatic failover.',
        usageTitle: 'Track usage',
        usageDesc: 'View balance, quotas, and spend in one place for team work.'
      }
    },
    // CTA section
    cta: {
  ...
  setup: {
    title: 'KQS API Setup',
    description: 'Configure your KQS API instance',
    database: {
  ...
  newUserGuide: {
    eyebrow: 'New user loop',
    openTutorial: 'Guide',
    title: 'Run Codex in four steps: buy code, redeem, create key, copy config',
    description:
      'The common stumbling points are now in one guide. You can continue from any user page without hunting for the next button.',
    stepsLabel: 'New user setup steps',
    progress: '{done}/{total} steps complete',
    context: {
      dashboard: 'Start here',
      redeem: 'Redeeming quota',
      keys: 'Configuring Codex'
    },
    steps: {
      purchase: {
        title: 'Buy a card code',
        description: 'Open the LDXP shop page, choose a package, pay, then copy the card code.'
      },
      redeem: {
        title: 'Redeem card code',
        description: 'Redeem the code in this site and the matching subscription quota is activated immediately.'
      },
      key: {
        title: 'Create Codex Key',
        description: 'Choose the codex group when creating the key. Quota can stay blank first.'
      },
      config: {
        title: 'Copy Codex config',
        description: 'Fill config.toml and OPENAI_API_KEY, with gpt-5.5 as the model.'
      }
    },
    packages: {
      title: 'Card packages',
      subtitle: 'Payment opens LDXP; this site only redeems the card code',
      recommended: 'Best pick',
      priceUnit: 'CNY',
      balanceLabel: 'subscription quota',
      names: {
        starter: 'Day starter',
        standard: 'Day pick',
        pro: 'Week pick'
    ...
    config: {
      title: 'Codex quick config',
      subtitle: 'Copy the config snippet without keeping the key visible on the page',
      configFilename: '~/.codex/config.toml',
      copyConfig: 'Copy config',
      copiedConfig: 'Codex config copied',
      copyEnv: 'Copy OPENAI_API_KEY',
      copiedEnv: 'OPENAI_API_KEY copied',
      noKeyTitle: 'No usable key yet',
      noKeyDescription: 'Create a key in the codex group first. After creation, one-click copy appears here.',
      keyReady: 'Key ready',
      maskedKeyLabel: 'Using: {key}'
    },
    guidance: {
      endpoint: 'Endpoint tip: set only base_url in Codex. Requests should reach {endpoint}; do not use /api/v1/responses.',
      noGroup: 'Ungrouped key found: click the group column and choose codex, otherwise Codex may not route.',
      insufficientBalance: 'If you see insufficient quota, buy a card code from LDXP, redeem it here, then try again.'
    },
    actions: {
      buyNow: 'Buy now',
      goRedeem: 'Redeem',
    ...
    modal: {
      ariaLabel: 'New user guide dialog',
      footerTitle: 'Read this once before operating to avoid the common traps.',
      footerDescription: 'Acknowledging stops the automatic popup in this browser. Use the Guide button in the top right to open the full guide anytime.',
      dontRemind: "Don't remind me",
      dontRemindSelected: "Don't remind selected",
  ...
  auth: {
    ...
    createPasswordPlaceholder: 'At least 8 chars, with letters and numbers',
    registerPasswordHint: 'At least 8 characters with both letters and numbers',
  ...
  dashboard: {
    ...
    serviceDesk: 'Team API desk',
    heroTitle: 'Start using KQS API here',
    heroDescription: 'Create one key, paste it into any OpenAI-compatible client, and watch balance, requests, and model usage from this page.',
    routeHealth: 'Current status',
    statusReady: 'Key ready',
    statusNeedsKey: 'Create a key first',
    balance: 'Balance',
    apiKeys: 'API Keys',
    todayRequests: 'Today Requests',
    todayCost: 'Today Cost',
    ...
    platformBreakdownHint: 'Sorted by actual spend so you can see which model platforms your team uses most.',
    ...
    buyRedeemCode: 'Buy card code',
    buyRedeemCodeDesc: 'Open LDXP to choose a day or week card',
    rechargeOrSubscribe: 'Recharge balance or buy a plan with in-site payment'
  },
  ...
  keys: {
    ...
    starter: {
      eyebrow: 'KQS API Service',
      title: 'Issue a controlled API key for yourself or classmates',
      description: 'Create a key, then copy it into Codex, OpenCode, or any OpenAI-compatible client. Quota, expiration, and groups can all be adjusted later.',
      stepsLabel: 'API key setup steps',
      stepCreate: 'Create a key and choose a group',
      stepCopy: 'Copy it or import to a client',
      stepUse: 'Track usage and adjust limits',
      totalLabel: 'Current keys'
    },
    createGuide: {
      name: 'Use a clear name, such as "Course Team Codex".',
      group: 'Choose the model group that this key is allowed to use.',
      limits: 'New keys are unlimited by default. Turn on quota or rate limits only when you want to cap usage.'
    },
    ccsGuide: {
      eyebrow: 'Codex Quick Start',
      title: 'Install CCSwitch, then import your key',
      description: 'The safest beginner path: install CCSwitch, return here and click "Import to CCS", then restart Codex. No manual config.toml editing needed.',
      stepsLabel: 'CCSwitch setup steps',
      stepDownloadTitle: 'Download CCSwitch',
      stepDownloadDescription: 'Install it from the official site and keep it running in the background.',
      stepImportTitle: 'Import this key',
      stepImportDescription: 'Click "Import to CCS" in the key list, or import the recommended key with the button.',
      stepRestartTitle: 'Restart Codex',
      stepRestartDescription: 'Fully quit and reopen Codex. New chats will use KQS API.',
      download: 'Download CCSwitch',
      importNow: 'Import active key',
      createFirst: 'Create a key first',
      needKeyFirst: 'Create and assign an active key before importing to CCS.'
    },
    endpoints: {
      title: 'API Endpoints',
      default: 'Default',
    ...
    keyCreatedSuccessNext: 'API key created. Next, copy the Codex config.',
    ...
    groupRequired: 'Please select a group. codex is recommended for Codex.',
    codexGuide: {
      defaultKeyName: 'Codex API Key'
    },
    usage: 'Usage',
    today: 'Today',
    total: 'Last 30d',
    ...
    useKeyModal: {
      ...
      openai: {
        description: 'Use CCSwitch import first. Manual setup only needs the two files below.',
        configTomlHint: 'Copy to .codex/config.toml',
        note: 'After saving the files, fully quit and restart Codex, then start a new chat.',
        noteWindows: 'After saving the files, fully quit and restart Codex, then start a new chat.',
      },
      cliTabs: {
      ...
      ccswitch: {
        ...
        title: 'Recommended: import to Codex',
        description: 'Install and open CCSwitch, click "Import to CCS", then restart Codex.',
        stepsLabel: 'CCSwitch import steps',
        stepDownloadTitle: 'Download and open CCSwitch',
        stepDownloadDescription: 'Keep it running in the background so it can receive the import request.',
        stepImportTitle: 'Click Import to CCS',
        stepImportDescription: 'The site writes base_url, model, and this key into CCSwitch for you.',
        stepRestartTitle: 'Restart Codex',
        stepRestartDescription: 'Close old Codex windows, reopen Codex, then start a new chat.',
        download: 'Download CCSwitch',
        import: 'Import to CCS',
      },
      manual: {
        eyebrow: 'Fallback route',
        title: 'Manual setup',
        description:
          'Only three steps: copy config.toml, copy auth.json, restart Codex.',
        folderLabel: 'Config directory',
        openDirWindows: 'Press Win+R and enter this path. Create .codex if it does not open.',
        openDirUnix: 'Run mkdir -p ~/.codex. In Finder, use Go to Folder and enter ~/.codex.',
        stepsLabel: 'Manual Codex setup steps',
        stepFolderTitle: 'Find the .codex folder',
        stepFolderDescription: 'The config directory is {dir}. Create it if it does not exist.',
        stepConfigTitle: 'Write config.toml',
        stepConfigDescription: 'Copy the config.toml block below into .codex/config.toml.',
        stepAuthTitle: 'Write auth.json',
        stepAuthDescription: 'Copy the auth.json block below into .codex/auth.json.',
        stepRestartTitle: 'Restart Codex',
        stepRestartDescription: 'Fully close Codex, reopen it, then start a new chat to test.',
        warning:
          'Use this site URL as base_url. Do not use /api/v1/responses or 127.0.0.1.',
      },
      codexApp: {
        eyebrow: 'Codex App GPT + domestic model bundle',
        title: 'Install GPT + domestic model profiles',
        description:
          'The config.toml and model catalog below group GPT, Qwen, DeepSeek, Kimi, GLM, Doubao, MiniMax, ERNIE, Spark, Hunyuan, and Yi. Copy and run the installer once on your machine; it backs up old config files and writes these profiles. Restart Codex App, then switch by profile or model picker.',
        profileCountLabel: 'Switchable models',
        usageHint:
          'CLI examples: codex -p gpt-5-5, codex -p qwen-plus, or codex -p deepseek-reasoner. Codex preserves thread history; switch models between turns for the smoothest result. This site exports GPT and domestic text models only; Claude, image, vision, and video models are excluded.',
        installScriptHint:
          'Optional one-click installer: backs up config.toml/auth.json, then merges this provider, profiles, and model catalog without overwriting MCP or trusted-project settings.',
        catalogHint:
          'Codex App model catalog: makes GPT and domestic models visible in the model picker instead of falling back to Custom.',
      },
    },
    ...
    ccSwitchImportStarted: 'Import started. Confirm the provider in the CCS window.',
    ccsClientSelect: {
      title: 'Select Client',
    ...
    quotaAmountHint: 'Set the maximum amount this key can spend. New Codex keys are unlimited by default; 0 = unlimited.',
    ...
    rateLimitHint: 'Set maximum spending within each time window. New keys are unlimited by default; 0 = unlimited.',
  ...
  redeem: {
    ...
    codeRedeemSuccessNext: 'Code redeemed. Next, create a Codex key.',
    failedToRedeem: 'Failed to redeem code. Please check the code and try again.',
    subscriptionRefreshFailed: 'Redeemed successfully, but failed to refresh subscription status.',
    pleaseEnterCode: 'Please enter a redeem code',
    nextCreateKey: 'Next: create Codex Key',
    nextViewUsage: 'View usage',
    errors: {
      used: 'This card code has already been used. Check whether you copied the wrong code, or confirm the new code in your LDXP order.',
      notFound: 'This card code was not found. Remove extra spaces, line breaks, or punctuation; if it still fails, contact the admin.',
      expired: 'This card code has expired. Contact the admin for a replacement.',
      rateLimited: 'Too many failed attempts. Please wait a while before trying again, or contact the admin.',
      locked: 'This code is being processed. Wait a few seconds and try again to avoid duplicate submissions.',
  ...
  admin: {
    ...
    groups: {
      ...
      codexAllModels: {
        title: 'Codex GPT + Domestic Model Import',
        tooltip: 'When enabled, users selecting this OpenAI group will see the Codex App/CLI import guide with GPT models, domestic text models, profiles, and model catalog.',
        enabled: 'Enable one-click Codex all-model import for this group',
        hint: 'Use only for GPT + domestic model bundle groups. Keep disabled for normal OpenAI groups.'
      }
    },
    ...
    subscriptions: {
      ...
      notesHint: 'Optional order ID, compensation reason, or internal note',
    ...
    accounts: {
      ...
      hero: {
        ...
        title: 'Turn upstream accounts into stable model routes',
        description: 'Add OpenAI, Claude, Gemini, and other accounts here, bind them to groups, then distribute access through user API keys.',
        stepsLabel: 'Account pool setup steps',
        stepAuthorize: 'Authorize or import accounts',
        stepRoute: 'Bind groups and routing',
        stepWatch: 'Watch status and refresh credentials',
        totalLabel: 'Total accounts',
        activeVisibleLabel: 'Ready on page',
        attentionVisibleLabel: 'Needs attention',
        selectedLabel: 'Selected'
      },
      supplyControl: {
        eyebrow: 'SUPPLY CONTROL',
        title: 'Tune account routing directly',
          description: 'Lower priority values are preferred first; load factor is a capacity reference, not a fixed traffic share. Actual share comes from the selected window and is also shaped by health, TTFT, load, and retries.',
          legend: 'Lower priority first · load factor is capacity · share is real traffic',
          window: 'Window',
          noSample: 'No sample',
          preferred: 'Preferred',
          fallback: 'Fallback',
          unavailable: 'Unavailable',
          groupPriorityTitle: 'Showing the selected group priority override; changes write to the group binding',
          globalPriorityTitle: 'Showing account-wide priority; select a group to edit its override',
        showColumns: 'Show detail columns',
        bulkSelected: 'Bulk tune selected',
        bulkFiltered: 'Bulk tune current filter',
        priorityShort: 'Pri',
        weightShort: 'Weight',
        ...
        updated: 'Supply weight updated',
        updateFailed: 'Failed to update supply weight'
      },
      createGuide: {
        eyebrow: 'ADD ACCOUNT',
        nameStep: 'Name it by source and purpose',
        openaiOauth: {
          title: 'Import ChatGPT / Codex account',
          description:
            'Use this when you have Codex JSON, auth.json, accessToken, or refresh_token. The next step opens the unified paste import.',
          typeStep: 'Choose OAuth account type',
          nextStep: 'Paste JSON / AT / RT next',
          namePlaceholder: 'Optional; auto-named by email or account ID',
          nameOptionalHint: 'For batch imports, leave this blank so accounts can be named from email, account ID, or import index.'
        },
        openaiApiKey: {
          title: 'Add OpenAI API key',
          description:
            'Use this for official or OpenAI-compatible API keys. Next, enter the upstream Base URL and key.',
          typeStep: 'Choose API Key account type',
          nextStep: 'Enter Base URL and API Key',
          namePlaceholder: 'e.g. OpenAI API key route'
        },
        gemini: {
          title: 'Add Gemini / Vertex account',
          description:
            'Choose OAuth, API Key, or Service Account based on where the account comes from. Personal accounts usually use OAuth.',
          typeStep: 'Choose Gemini account source',
          nextStep: 'Authorize or paste credentials',
          namePlaceholder: 'e.g. Gemini Google One'
        },
        antigravity: {
          title: 'Add Antigravity account',
          description: 'Connect an OAuth account or upstream service for a dedicated Antigravity route.',
          typeStep: 'Choose OAuth or upstream',
          nextStep: 'Authorize or enter upstream config',
          namePlaceholder: 'e.g. Antigravity account 1'
        },
        anthropicApiKey: {
          title: 'Add Claude API key',
          description: 'Use this for Anthropic Console keys. After saving, it can join group scheduling.',
          typeStep: 'Choose Claude Console',
          nextStep: 'Enter API Key and Base URL',
          namePlaceholder: 'e.g. Claude Console key'
        },
        anthropicBedrock: {
          title: 'Add Bedrock Claude route',
          description:
            'Use this for AWS Bedrock. Enter region and credentials, then map Claude models.',
          typeStep: 'Choose Bedrock type',
          nextStep: 'Enter AWS credentials and region',
          namePlaceholder: 'e.g. Bedrock Claude us-east-1'
        },
        vertexService: {
          title: 'Add Vertex Service Account',
          description:
            'Use this for Google Cloud service account JSON. Routing follows the selected project and location.',
          typeStep: 'Choose Service Account',
          nextStep: 'Paste service account JSON',
          namePlaceholder: 'e.g. Vertex Service Account'
        },
        anthropicOauth: {
          title: 'Add Claude Code account',
          description:
            'Use this for Claude subscription accounts or setup tokens. Next step opens the authorization flow.',
          typeStep: 'Choose Claude Code',
          nextStep: 'Complete Claude authorization',
          namePlaceholder: 'e.g. Claude Pro primary'
        }
      },
      createAccount: 'Create Account',
      ...
      supplyProfile: {
        ...
        description: 'Combine priority, weight, and request body ceiling into a controllable routing profile. Limit low-cost relays to small requests so large uploads skip them automatically.',
        priority: 'Priority',
        priorityHint: 'Lower numbers are selected first.',
        weight: 'Weight',
        weightHint: 'Higher weights receive more traffic within the same priority band.',
        maxBodyMB: 'Max body MB',
        maxBodyPlaceholder: '0 or blank means unlimited',
        maxBodyHint: 'For example, set 10 to keep uploads over 10MB away from this account.',
        presets: {
          lowCostSmall: 'Low-cost small',
          balanced: 'Balanced main',
      ...
      oauth: {
        ...
        methodDescriptions: {
          manual: 'Best for first-time authorization. Generate a link, sign in, then paste the callback link or code.',
          cookie: 'Best for Claude sessionKey. The system completes authorization automatically.',
          refreshToken: 'Fastest when you already have refresh tokens. Supports one per line.',
          mobileRefreshToken: 'Use a refresh token from a mobile client for OpenAI account import.',
          sessionToken: 'Use an existing session token and let the system parse usable credentials.',
          accessToken: 'Use an existing accessToken, usually together with a known expiration time.',
          codexSession: 'Best for session JSON, auth.json, account JSON, Sub2API JSON, AT, or RT. Supports batch paste.'
        },
        ...
        openai: {
          ...
          quickGuide: {
            choose: 'Prefer Codex JSON / AT batch input for the shortest path.',
            paste: 'Paste JSON, accessToken, or one token per line.',
            create: 'Accounts use the name, groups, and limits from step 1.'
          },
          // Refresh Token auth
          ...
          codexSessionAuth: 'JSON / AT / RT Batch Input',
          codexSessionDesc: 'Paste session JSON, auth.json, account JSON, Sub2API JSON, accessToken, or refresh_token. Accounts use the step 1 settings.',
          codexSessionInputLabel: 'session JSON / auth.json / account JSON / Sub2API JSON / AT / RT',
          codexSessionPlaceholder: 'Multiple lines supported: one token, refresh_token, or JSON per line; JSON arrays are supported too',
          ...
          codexSessionAcceptJson: 'JSON / auth.json',
          codexSessionAcceptAccessToken: 'accessToken',
          codexSessionAcceptRefreshToken: 'refresh_token',
          codexSessionTipOnePerLine: 'For multiple accounts, paste a JSON array or use one token / refresh_token / compact JSON object per line.',
          codexSessionTipRefreshToken: 'refresh_token-only imports are exchanged online first; accounts with refresh_token can refresh automatically.',
          codexSessionTipAccessToken: 'For accessToken-only imports, make sure expiration can be parsed or set one in step 1.',
    ...
    ops: {
      ...
      errorLog: {
        ...
        status: 'Status',
        recovered: 'Recovered',
        recoveredUpstreamStatus: 'The upstream returned {status}; failover ultimately succeeded',
        message: 'Message',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for KQS API end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for KQS API end-user login',
      ...
      site: {
        ...
        siteName: 'Site Name',
        siteNamePlaceholder: 'KQS API',
        siteNameHint: 'Displayed in emails and page titles',
        siteSubtitle: 'Site Subtitle',
        siteSubtitlePlaceholder: 'KQS AI API Gateway Platform',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 Welcome to KQS API',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">KQS API is a powerful AI service gateway platform that helps you easily manage and distribute AI services.</p><p style="margin-bottom: 12px;"><b>🎯 Core Features:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>Group Management</b> - Create service tiers (VIP, Free Trial, etc.)</li><li>🔗 <b>Account Pool</b> - Connect multiple upstream AI service accounts</li><li>🔑 <b>Key Distribution</b> - Generate independent API Keys for users</li><li>💰 <b>Billing Control</b> - Flexible rate and quota management</li></ul><p style="color: #10b981; font-weight: 600;">Let\'s complete the initial setup in 3 minutes →</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
        title: '📦 Step 1: Group Management',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>What is a Group?</b></p><p style="margin-bottom: 12px;">Groups are the core concept of KQS API, like a "service package":</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 Each group can contain multiple upstream accounts</li><li>💰 Each group has independent billing multiplier</li><li>👥 Can be set as public or exclusive</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 Example:</b> You can create "VIP Premium" (high rate) and "Free Trial" (low rate) groups</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 Click "Group Management" on the left sidebar</p></div>'
      },
      createGroup: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to KQS API',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the KQS API AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {

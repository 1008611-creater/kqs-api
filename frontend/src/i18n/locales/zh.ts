export default {
  ...
  home: {
    ...
    getStarted: '立即开始',
    goToDashboard: '进入控制台',
    eyebrow: '面向学习与协作的 AI 接口服务',
    // 新增：面向用户的价值主张
    heroSubtitle: '一个密钥，畅用多个 AI 模型',
    heroDescription: '无需管理多个订阅账号，一站式接入 Claude、GPT、Gemini 等主流 AI 服务',
    tags: {
      subscriptionToApi: '创建密钥',
      stickySession: '选择模型',
      realtimeBilling: '查询用量'
    },
    terminal: {
      routing: '正在选择可用通道...'
    },
    ...
    providers: {
      title: '兼容主流模型调用',
      description: '通过统一接口接入已配置的模型，团队成员不必分别维护各个平台。',
      supported: '已支持',
      soon: '即将推出',
      claude: 'Claude',
      gemini: 'Gemini',
    ...
    authShell: {
      ...
      title: '面向同学和团队的矿泉水 AI 接口平台',
      description: '统一管理密钥、模型路由和用量查询，把 Claude、GPT、Gemini 等能力整理成一处可控入口。',
      proof: {
        keysTitle: '密钥与分组',
        keysDesc: '按成员、课程项目和使用额度分开管理。',
        routingTitle: '账号池路由',
        routingDesc: '多上游账号调度，异常时自动切换。',
        usageTitle: '用量可追踪',
        usageDesc: '余额、配额和消费记录集中查看，方便团队协作。'
      }
    },
    // CTA 区块
    cta: {
  ...
  newUserGuide: {
    eyebrow: '新手闭环',
    openTutorial: '使用教程',
    title: '四步跑通 Codex：买卡密、兑换、建 Key、复制配置',
    description:
      '把同学最容易卡住的地方放在同一张引导卡里。你可以从任意页面继续下一步，不需要去猜按钮藏在哪里。',
    stepsLabel: '新手使用步骤',
    ...
    steps: {
      purchase: {
        title: '购买卡密',
        description: '在链动小铺店铺页选择日卡或周卡套餐，付款后复制卡密。'
      },
      redeem: {
        title: '兑换卡密',
        description: '回到站内兑换卡密，对应订阅额度会立即开通。'
      },
      key: {
        title: '创建 Codex Key',
        description: '创建密钥时选择 codex 分组，默认额度可以先留空。'
      },
      config: {
        title: '复制 Codex 配置',
        description: '把 config.toml 和 OPENAI_API_KEY 填好，模型使用 gpt-5.5。'
      }
    },
    packages: {
      title: '购买卡密套餐',
      subtitle: '跳转链动小铺付款，站内只负责兑换卡密',
      recommended: '推荐',
      priceUnit: '元',
      balanceLabel: '订阅额度',
      names: {
    ...
    config: {
      title: 'Codex 一键配置',
      subtitle: '只复制配置片段，不在页面长期明文展示 Key',
      configFilename: '~/.codex/config.toml',
      copyConfig: '复制配置',
      copiedConfig: 'Codex 配置已复制',
      copyEnv: '复制 OPENAI_API_KEY',
      copiedEnv: 'OPENAI_API_KEY 已复制',
      noKeyTitle: '还没有可用 Key',
      noKeyDescription: '先创建一个选择 codex 分组的 Key；创建成功后这里会提供一键复制。',
      keyReady: 'Key 已就绪',
      maskedKeyLabel: '当前使用：{key}'
    },
    guidance: {
      endpoint: '接口路径提醒：Codex 只填 base_url，实际请求应到 {endpoint}，不要写 /api/v1/responses。',
      noGroup: '发现未分组 Key：点击密钥表格里的“分组”，选择 codex，否则 Codex 可能无法调度。',
      insufficientBalance: '如果提示额度不足，先在链动小铺购买卡密并回站内兑换，再回来继续调用。'
    },
    actions: {
      buyNow: '去购买',
      goRedeem: '去兑换',
    ...
    modal: {
      ariaLabel: '新手闭环弹窗',
      footerTitle: '先看完这张图，再开始操作会少走很多弯路。',
      footerDescription: '点“我已知晓”后这台浏览器不再自动弹出；右上角“使用教程”可随时查看完整教程。',
      dontRemind: '不再提醒',
      dontRemindSelected: '已选择不再提醒',
      acknowledge: '我已知晓'
    }
  },
  ...
  auth: {
    ...
    createPasswordPlaceholder: '至少 8 位，含英文字母和数字',
    registerPasswordHint: '至少 8 位，必须同时包含英文字母和数字',
    emailRequired: '请输入邮箱',
    invalidEmail: '请输入有效的邮箱地址',
    passwordRequired: '请输入密码',
    passwordMinLength: '密码至少需要 8 个字符',
    registerPasswordInvalid: '密码至少需要 8 位，并且必须同时包含英文字母和数字',
  ...
  dashboard: {
    ...
    serviceDesk: '团队接口服务台',
    heroTitle: '从这里开始使用矿泉水API',
    heroDescription: '先创建一个密钥，再把它填到支持 OpenAI 格式的软件里；这里会持续显示余额、请求量和模型用量。',
    routeHealth: '当前可用状态',
    statusReady: '已有可用密钥',
    statusNeedsKey: '先创建密钥',
    balance: '余额',
    apiKeys: 'API 密钥',
    todayRequests: '今日请求',
    todayCost: '今日消费',
    ...
    platformBreakdownHint: '按实际消费排序，方便判断团队主要在用哪些模型平台。',
    ...
    buyRedeemCode: '购买卡密',
    buyRedeemCodeDesc: '跳转链动小铺选择日卡或周卡',
    rechargeOrSubscribe: '使用站内支付充值余额或购买套餐'
  },
  ...
  keys: {
    ...
    starter: {
      ...
      title: '创建可控的调用密钥',
      description: '先创建密钥，再复制到 Codex、OpenCode 或其它兼容 OpenAI 的客户端里。额度、有效期和分组都可以随时调整。',
      stepsLabel: '密钥使用步骤',
      stepCreate: '创建密钥并选择分组',
      stepCopy: '复制密钥或一键导入客户端',
      stepUse: '查看用量并及时调整额度',
      totalLabel: '当前密钥'
    },
    createGuide: {
      name: '名称写清用途，比如“课程小组 Codex”。',
      group: '选择对应模型分组，决定这个密钥能调用哪些服务。',
      limits: '新建密钥默认不限制用量；需要控制额度或速率时，可以手动开启限制。'
    },
    ccsGuide: {
      eyebrow: 'Codex 快速接入',
      title: '装好 CCSwitch，再一键导入密钥',
      description: '最稳的新手路线：先安装 CCSwitch，回到本页点“导入到 CCS”，最后重启 Codex。这样不用手改 config.toml。',
      stepsLabel: 'CCSwitch 接入步骤',
      stepDownloadTitle: '下载 CCSwitch',
      stepDownloadDescription: '从官方站点下载安装，打开后保持后台运行。',
      stepImportTitle: '导入这把 Key',
      stepImportDescription: '在密钥列表点“导入到 CCS”，或用右侧按钮导入可用密钥。',
      stepRestartTitle: '重启 Codex',
      stepRestartDescription: '完全退出后重新打开 Codex，新对话就会走矿泉水API。',
      download: '下载 CCSwitch',
      importNow: '导入可用 Key',
      createFirst: '先创建 Key',
      needKeyFirst: '请先创建并分配一把可用密钥，再导入 CCS。'
    },
    endpoints: {
      title: 'API 端点',
      default: '默认',
    ...
    keyCreatedSuccessNext: 'API 密钥创建成功，下一步复制 Codex 配置。',
    ...
    groupRequired: '请选择分组。Codex 推荐选择 codex 分组。',
    codexGuide: {
      defaultKeyName: 'Codex 调用 Key'
    },
    usage: '用量',
    today: '今日',
    total: '近30天',
    ...
    useKeyModal: {
      ...
      openai: {
        description: '推荐先一键导入到 CCSwitch；手动配置只需要下面两个文件。',
        configTomlHint: '复制到 .codex/config.toml',
        note: '配置后完全退出并重启 Codex，再新建对话测试。',
        noteWindows:
          '配置后完全退出并重启 Codex，再新建对话测试。'
      },
      cliTabs: {
      ...
      ccswitch: {
        eyebrow: '新手推荐',
        title: '推荐：一键导入 Codex',
        description: '安装并打开 CCSwitch，点“导入到 CCS”，然后重启 Codex。',
        stepsLabel: 'CCSwitch 导入步骤',
        stepDownloadTitle: '下载并打开 CCSwitch',
        stepDownloadDescription: '安装后保持后台运行，让系统能接收导入请求。',
        stepImportTitle: '点击导入到 CCS',
        stepImportDescription: '本站会把 base_url、模型和当前密钥一起写入 CCSwitch。',
        stepRestartTitle: '重启 Codex',
        stepRestartDescription: '关闭旧窗口后重新打开 Codex，再发起一次新对话。',
        download: '下载 CCSwitch',
        import: '导入到 CCS'
      },
      manual: {
        ...
        title: '手动配置',
        description:
          '只做三件事：复制 config.toml、复制 auth.json、重启 Codex。',
        folderLabel: '配置目录',
        openDirWindows: '按 Win+R 输入这个路径；打不开就新建 .codex 文件夹。',
        openDirUnix: '终端执行 mkdir -p ~/.codex；Finder 可用前往文件夹输入 ~/.codex。',
        stepsLabel: 'Codex 手动配置步骤',
        stepFolderTitle: '找到 .codex 文件夹',
        stepFolderDescription: '配置目录是 {dir}，不存在就新建一个同名文件夹。',
        stepConfigTitle: '写入 config.toml',
        stepConfigDescription: '复制下面 config.toml，粘贴到 .codex/config.toml。',
        stepAuthTitle: '写入 auth.json',
        stepAuthDescription: '复制下面 auth.json，保存到 .codex/auth.json。',
        stepRestartTitle: '重启 Codex',
        stepRestartDescription: '完全退出旧窗口，重新打开后新建对话测试。',
        warning:
          '注意：base_url 用本站地址即可，不要填 /api/v1/responses 或 127.0.0.1。'
      },
      codexApp: {
        eyebrow: 'Codex App GPT + 国产模型合集',
        title: '一键写入 GPT + 国产模型 Profiles',
        description:
          '下面的 config.toml 和 model catalog 已经把 GPT、Qwen、DeepSeek、Kimi、GLM、豆包、MiniMax、文心、星火、混元、Yi 分好组。复制安装脚本在本机运行一次，会备份旧配置并写入这些 profiles；重启 Codex App 后即可按 profile 或模型选择器切换。',
        profileCountLabel: '可切换模型',
        usageHint:
          'CLI 可用 codex -p gpt-5-5、codex -p qwen-plus、codex -p deepseek-reasoner 直接启动；Codex App 使用模型选择器切换时，历史线程由 Codex 保留，建议在两轮对话之间切换。本站只下发 GPT 和国产文本模型，不包含 Claude、图片、视觉或视频模型。',
        installScriptHint:
          '可选一键安装脚本：会备份当前 config.toml/auth.json，再合并写入本站 provider、profiles 和 model catalog，不会覆盖 MCP、项目信任等其他配置。',
        catalogHint:
          'Codex App 模型目录：让 GPT 和国产模型在模型选择器里显示为可选模型，避免显示成“自定义”。'
      }
    },
    ...
    ccSwitchImportStarted: '已发起导入，请在 CCS 确认窗口中完成导入。',
    ccsClientSelect: {
      title: '选择客户端',
    ...
    quotaAmountHint: '设置此密钥可消费的最大金额。新建 Codex Key 默认无限制；0 = 无限制。',
    quotaUsed: '已用额度',
    reset: '重置',
    ...
    rateLimitHint: '设置此密钥在指定时间窗口内的最大消费额。新建 Key 默认无限制；0 = 无限制。',
  ...
  affiliate: {
    title: '邀请返利',
    description: '分享邀请码邀请新用户，对方充值余额或购买订阅后，你获得 10% 返利',
    yourCode: '我的邀请码',
    inviteLink: '邀请链接',
    copyCode: '复制邀请码',
    copyLink: '复制链接',
    ...
    stats: {
      rebateRate: '我的返利比例',
      rebateRateHint: '被邀请用户充值余额、购买或兑换订阅后你可获得的返利比例',
      invitedUsers: '邀请人数',
    ...
    transfer: {
      title: '返利额度转余额',
      description: '返利先进入可转返利额度，转入后可像普通余额一样使用',
      button: '转入余额',
      transferring: '转入中...',
      empty: '当前没有可转入额度',
    ...
    tips: {
      title: '返利规则',
      line1: '新用户通过你的邀请码或邀请链接注册后，会绑定为你的邀请用户。',
      line2: 'TA 后续充值余额、购买订阅订单，或兑换订阅卡密时，你获得对应金额 {rate} 的返利。',
      line3: '返利进入“可转返利额度”，点击转入余额后即可用于站内消费。',
      line4: '新产生的返利需要经过冻结期后才能转入余额。'
    }
  },
  ...
  redeem: {
    ...
    codeRedeemSuccessNext: '兑换成功！下一步去创建 Codex Key。',
    failedToRedeem: '兑换失败，请检查兑换码后重试。',
    subscriptionRefreshFailed: '兑换成功，但订阅状态刷新失败。',
    pleaseEnterCode: '请输入兑换码',
    nextCreateKey: '下一步：创建 Codex Key',
    nextViewUsage: '查看用量记录',
    errors: {
      used: '这个卡密已经被使用过。请检查是否复制错了，或回到链动小铺订单里确认新的卡密。',
      notFound: '没有找到这个卡密。请确认没有多复制空格、换行或中文符号；仍失败就联系管理员核对订单。',
      expired: '这个卡密已过期。请联系管理员换一个新的卡密。',
      rateLimited: '错误次数有点多，系统暂时限制兑换。稍等一会儿再试，或联系管理员处理。',
      locked: '这个卡密正在处理中，请等几秒再试一次，避免重复提交。',
  ...
  admin: {
    ...
    dashboard: {
      ...
      tokenUsageTrend: 'Token 使用趋势',
      userUsageTrend: '用户实际消费趋势（前 12 位）',
      noDataAvailable: '暂无数据',
      model: '模型',
      group: '分组',
      noGroup: '无分组',
    ...
    groups: {
      ...
      codexAllModels: {
        title: 'Codex GPT + 国产模型合集导入',
        tooltip: '启用后，选择此 OpenAI 分组的用户会在 Key 使用弹窗里看到 Codex App/CLI 专属导入：包含 GPT 模型、国产文本模型、profiles 和 model catalog。',
        enabled: '给此分组开启一键导入全部 Codex 模型',
        hint: '只建议给“GPT + 国产模型合集”这类分组开启；普通 OpenAI 分组保持关闭。'
      }
    },
    ...
    accounts: {
      ...
      hero: {
        ...
        title: '把上游账号整理成稳定的模型通道',
        description: '这里负责添加 OpenAI、Claude、Gemini 等账号，再把账号绑定到分组，最后通过密钥分发给同学使用。',
        stepsLabel: '账号池配置步骤',
        stepAuthorize: '授权或导入账号',
        stepRoute: '绑定分组与调度策略',
        stepWatch: '观察状态并刷新凭据',
        totalLabel: '账号总数',
        activeVisibleLabel: '本页可用',
        attentionVisibleLabel: '本页需关注',
        selectedLabel: '已选择'
      },
      supplyControl: {
        eyebrow: 'SUPPLY CONTROL',
        title: '直接调账号供给顺序',
          description: '优先级数字越小越先被调度；承载因子表示可承受的并发容量，不是固定流量比例。实际占比看统计窗口内的真实请求，健康度、首字延迟、负载和失败重试也会影响结果。',
          legend: '优先级越小越优先 · 承载因子是容量参考 · 占比为真实请求统计',
          window: '窗口',
          noSample: '暂无样本',
          preferred: '优先候选',
          fallback: '候补',
          unavailable: '不可调度',
          groupPriorityTitle: '当前显示的是所选分组 priority；调整会写入分组覆盖值',
          globalPriorityTitle: '当前显示的是账号全局 priority；选择分组后会显示分组覆盖值',
        showColumns: '显示详细列',
        bulkSelected: '批量调选中',
        bulkFiltered: '批量调当前筛选',
        priorityShort: '优先',
        weightShort: '权重',
        raisePriority: '提高优先级',
        lowerPriority: '降低优先级',
      ...
      createGuide: {
        ...
        openaiOauth: {
          ...
          description:
            '适合你手里有 Codex JSON、auth.json、accessToken 或 refresh_token 的情况。下一步会直接进入统一粘贴导入。',
          typeStep: '选择 OAuth 账号类型',
          nextStep: '下一步粘贴 JSON / AT / RT',
          namePlaceholder: '可留空，系统会按邮箱或账号 ID 命名',
          nameOptionalHint: '批量导入时建议留空，系统会自动用邮箱、账号 ID 或导入序号生成名称。'
        },
        openaiApiKey: {
          title: '添加 OpenAI API Key',
          description:
            '适合你有官方或兼容 OpenAI 的 API Key。下一步直接填写上游 Base URL 和 Key。',
          typeStep: '选择 API Key 账号类型',
          nextStep: '填写 Base URL 和 API Key',
          namePlaceholder: '例如：OpenAI API Key 通道'
        },
        gemini: {
          title: '添加 Gemini / Vertex 账号',
          description:
            '根据账号来源选择 OAuth、API Key 或 Service Account。个人账号通常选 OAuth。',
          typeStep: '选择 Gemini 账号来源',
          nextStep: '按类型完成授权或粘贴密钥',
          namePlaceholder: '例如：Gemini Google One'
        },
        antigravity: {
          title: '添加 Antigravity 账号',
          description: '可接入 OAuth 账号或上游服务，适合单独维护 Antigravity 通道。',
          typeStep: '选择 OAuth 或上游服务',
          nextStep: '完成授权或填写上游配置',
          namePlaceholder: '例如：Antigravity 账号 1'
        },
        anthropicApiKey: {
          title: '添加 Claude API Key',
          description: '适合 Anthropic Console Key。保存后可和其它账号一起进入分组调度。',
          typeStep: '选择 Claude Console',
          nextStep: '填写 API Key 和 Base URL',
          namePlaceholder: '例如：Claude Console Key'
        },
        anthropicBedrock: {
          title: '添加 Bedrock Claude 通道',
          description: '适合 AWS Bedrock 账号。需要填写区域和认证信息，再映射 Claude 模型。',
          typeStep: '选择 Bedrock 类型',
          nextStep: '填写 AWS 凭据和区域',
          namePlaceholder: '例如：Bedrock Claude us-east-1'
        },
        vertexService: {
          title: '添加 Vertex Service Account',
          description: '适合 Google Cloud 服务账号 JSON。导入后会按项目和区域调度模型。',
          typeStep: '选择 Service Account',
          nextStep: '粘贴服务账号 JSON',
          namePlaceholder: '例如：Vertex Service Account'
        },
        anthropicOauth: {
          title: '添加 Claude Code 账号',
          description: '适合 Claude 订阅账号或 setup token。下一步会进入授权流程。',
          typeStep: '选择 Claude Code',
          nextStep: '下一步完成 Claude 授权',
          namePlaceholder: '例如：Claude Pro 主账号'
        }
      },
      createAccount: '添加账号',
      autoRefresh: '自动刷新',
      ...
      supplyProfile: {
        title: '供给策略',
        description: '把现有优先级、权重和请求体上限组合成可控供给。低成本中转站建议限制小请求，大请求会自动跳过。',
        priority: '优先级',
        priorityHint: '数字越小越先被选中。',
        weight: '权重',
        weightHint: '权重越大，同优先级下分到的流量越多。',
        maxBodyMB: '请求体上限 MB',
        maxBodyPlaceholder: '0 或留空表示不限',
        maxBodyHint: '例如填 10，可避免超过 10MB 的上传请求打到此账号。',
        presets: {
          lowCostSmall: '低成本小请求',
          balanced: '均衡主力',
          fallback: '稳定兜底'
      ...
      oauth: {
        ...
        recommended: '推荐',
        methodDescriptions: {
          manual: '适合第一次授权，系统生成链接，你登录后粘贴回调链接或 code。',
          cookie: '适合 Claude sessionKey，可自动完成授权。',
          refreshToken: '已有 Refresh Token 时最快，支持一行一个批量创建。',
          mobileRefreshToken: '来自移动端的 Refresh Token，用于 OpenAI 账号导入。',
          sessionToken: '已有 Session Token 时使用，系统会尝试解析可用凭据。',
          accessToken: '已有 accessToken 时使用，通常需要配合有效期。',
          codexSession: '最适合 session JSON、auth.json、账号 JSON、Sub2API JSON、AT 或 RT，支持批量粘贴。'
        },
        ...
        openai: {
          ...
          quickGuide: {
            choose: '优先选择 Codex JSON / AT 批量输入，最少操作。',
            paste: '把 JSON、accessToken 或每行一个 token 粘贴进去。',
            create: '系统会按第一步的名称、分组和限额创建账号。'
          },
          // Refresh Token auth
          ...
          codexSessionAuth: 'JSON / AT / RT 批量输入',
          codexSessionDesc: '粘贴 session JSON、auth.json、账号 JSON、Sub2API JSON、accessToken 或 refresh_token，按第一步配置创建账号。',
          codexSessionInputLabel: 'session JSON / auth.json / 账号 JSON / Sub2API JSON / AT / RT',
          codexSessionPlaceholder: '支持多行，每行一个 token、refresh_token 或 JSON；也支持 JSON 数组批量导入',
          ...
          codexSessionTipOnePerLine: '多账号导入时建议粘贴 JSON 数组，或一行一个 token / refresh_token / 紧凑 JSON。',
          codexSessionTipRefreshToken: '仅 refresh_token 会先联网换取完整凭据；包含 refresh_token 的账号后续可自动刷新。',
          codexSessionTipAccessToken: '只有 accessToken 时请确认能解析过期时间，或在第一步手动设置过期时间。',
    ...
    ops: {
      ...
      errorLog: {
        ...
        status: '状态码',
        recovered: '已恢复',
        recoveredUpstreamStatus: '上游曾返回 {status}，故障切换后用户最终成功',
        message: '响应内容',
        latency: '请求时长',
        action: '操作',
        noErrors: '该窗口内暂无错误。',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: '配置 LinuxDo Connect OAuth，用于 矿泉水API 用户登录',
      ...
      dingtalk: {
        title: '钉钉登录',
        description: '配置钉钉 OAuth，用于 矿泉水API 用户登录',
      ...
      site: {
        ...
        siteNamePlaceholder: '矿泉水API',
        siteSubtitle: '站点副标题',
        siteSubtitleHint: '显示在登录和注册页面',
        siteSubtitlePlaceholder: '矿泉水 AI API 网关平台',
        apiBaseUrl: 'API 端点地址',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 欢迎使用 矿泉水API',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">矿泉水API 是一个强大的 AI 服务中转平台，让您轻松管理和分发 AI 服务。</p><p style="margin-bottom: 12px;"><b>🎯 核心功能：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>分组管理</b> - 创建不同的服务套餐（VIP、免费试用等）</li><li>🔗 <b>账号池</b> - 连接多个上游 AI 服务商账号</li><li>🔑 <b>密钥分发</b> - 为用户生成独立的 API Key</li><li>💰 <b>计费管理</b> - 灵活的费率和配额控制</li></ul><p style="color: #10b981; font-weight: 600;">接下来，我们将用 3 分钟带您完成首次配置 →</p></div>',
        nextBtn: '开始配置 🚀',
        prevBtn: '跳过'
      },
      groupManage: {
        title: '📦 第一步：分组管理',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>什么是分组？</b></p><p style="margin-bottom: 12px;">分组是 矿泉水API 的核心概念，它就像一个"服务套餐"：</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 每个分组可以包含多个上游账号</li><li>💰 每个分组有独立的计费倍率</li><li>👥 可以设置为公开或专属分组</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 示例：</b>您可以创建"VIP专线"（高倍率）和"免费试用"（低倍率）两个分组</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 点击左侧的"分组管理"开始</p></div>'
      },
      createGroup: {
        title: '➕ 创建新分组',
        description:
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用 矿泉水API',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到 矿泉水API AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {

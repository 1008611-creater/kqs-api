            ...
            <div v-else class="flex items-center gap-1.5">
              ...
              >
                <Icon
                  name="infoCircle"
                  size="xs"
                  class="flex h-4 w-4 cursor-help items-center justify-center text-gray-400 transition-colors group-hover:text-blue-500 dark:text-gray-500 dark:group-hover:text-blue-400"
                />
              </div>
            </div>
          </template>
...
<style scoped>
.usage-page-layout {
  --usage-panel: rgba(5, 29, 24, 0.78);
  --usage-soft: rgba(3, 22, 18, 0.72);
  --usage-line: rgba(43, 132, 83, 0.38);
  --usage-text: #edf7ee;
  --usage-muted: rgba(220, 239, 224, 0.64);
  --usage-accent: #22c55e;
  gap: 0.85rem;
  min-height: calc(100vh - 5.5rem);
}

.usage-page-layout :deep(.layout-section-fixed) {
...
.usage-page-layout :deep(.layout-section-fixed:first-child) {
  background:
    radial-gradient(circle at 8% 12%, rgba(34, 197, 94, 0.12), transparent 28%),
    var(--usage-panel);
}

.usage-page-layout :deep(.layout-section-fixed .grid) {
  gap: 0.75rem;
}

.usage-page-layout :deep(.layout-section-fixed .card) {
  border: 1px solid rgba(43, 132, 83, 0.32);
  border-radius: 8px;
  background: rgba(3, 22, 18, 0.62);
  color: var(--usage-text);
  box-shadow: none;
}

.usage-page-layout :deep(.layout-section-fixed .card.p-4) {
  padding: 0.85rem;
}

.usage-page-layout :deep(.layout-section-fixed .card > .px-6) {
  padding: 0;
}

.usage-page-layout :deep(.layout-section-fixed .card > .px-6.py-4) {
  padding: 0.05rem;
}

.usage-page-layout :deep(.input-label) {
  color: rgba(220, 239, 224, 0.68);
  font-size: 0.8rem;
  font-weight: 700;
}

.usage-page-layout :deep(.input),
.usage-page-layout :deep(input),
.usage-page-layout :deep(.date-picker-trigger),
.usage-page-layout :deep(.select-trigger),
.usage-page-layout :deep([role="combobox"]) {
  border-color: var(--usage-line);
  background-color: rgba(3, 22, 18, 0.72);
  color: var(--usage-text);
}

.usage-page-layout :deep(.input::placeholder),
.usage-page-layout :deep(input::placeholder) {
  color: rgba(220, 239, 224, 0.48);
}

.usage-page-layout :deep(.date-picker-trigger:hover),
.usage-page-layout :deep(.select-trigger:hover),
.usage-page-layout :deep([role="combobox"]:hover) {
  border-color: rgba(34, 197, 94, 0.52);
  background-color: rgba(34, 197, 94, 0.1);
}

.usage-page-layout :deep(.btn-secondary) {
  border-color: var(--usage-line);
  background: rgba(3, 22, 18, 0.66);
  color: var(--usage-text);
}

.usage-page-layout :deep(.btn-secondary:hover) {
  border-color: rgba(34, 197, 94, 0.52);
  background: rgba(34, 197, 94, 0.12);
}

.usage-page-layout :deep(.btn-primary) {
  border-color: rgba(34, 197, 94, 0.52);
  background: linear-gradient(180deg, rgba(34, 197, 94, 0.96), rgba(15, 122, 58, 0.96));
  color: #effaf2;
  box-shadow: 0 10px 24px rgba(34, 197, 94, 0.18);
}

.usage-page-layout :deep(.table-scroll-container),
.usage-page-layout :deep(.table-wrapper) {
  overflow: hidden;
  border: 1px solid var(--usage-line);
  border-radius: 8px;
  background: var(--usage-panel);
...
.usage-page-layout :deep(.table-scroll-container) {
  min-height: clamp(25rem, 48vh, 42rem);
}

.usage-page-layout :deep(table) {
  background: transparent;
}

.usage-page-layout :deep(.table-header),
.usage-page-layout :deep(thead),
.usage-page-layout :deep(.sticky-header-cell) {
...
.usage-page-layout :deep(thead th) {
  border-color: rgba(43, 132, 83, 0.32);
  color: rgba(220, 239, 224, 0.78) !important;
  font-weight: 760;
}

.usage-page-layout :deep(thead th:hover),
.usage-page-layout :deep(.sticky-header-cell:hover),
.usage-page-layout :deep(.cursor-pointer:hover) {
  background: rgba(12, 58, 43, 0.98) !important;
  background-color: rgba(12, 58, 43, 0.98) !important;
}

.usage-page-layout :deep(tbody tr) {
  background: rgba(5, 29, 24, 0.54);
}

.usage-page-layout :deep(tbody tr:hover) {
  background: rgba(34, 197, 94, 0.08);
}

.usage-page-layout :deep(tbody td) {
  border-color: rgba(43, 132, 83, 0.28);
  color: var(--usage-text);
}

.usage-page-layout :deep(.sticky-col),
.usage-page-layout :deep(tbody .sticky-col) {
  background: rgba(5, 29, 24, 0.96) !important;
  background-color: rgba(5, 29, 24, 0.96) !important;
}

.usage-page-layout :deep(tbody tr:hover .sticky-col) {
  background: rgba(12, 58, 43, 0.98) !important;
  background-color: rgba(12, 58, 43, 0.98) !important;
}

.usage-page-layout :deep(.text-gray-900),
.usage-page-layout :deep(.dark\:text-white) {
  color: var(--usage-text) !important;
}

.usage-page-layout :deep(.text-gray-600),
.usage-page-layout :deep(.text-gray-500),
.usage-page-layout :deep(.text-gray-400),
.usage-page-layout :deep(.dark\:text-gray-300),
.usage-page-layout :deep(.dark\:text-gray-400),
.usage-page-layout :deep(.dark\:text-gray-500),
.usage-page-layout :deep(.dark\:text-dark-400),
.usage-page-layout :deep(.dark\:text-dark-500) {
  color: var(--usage-muted) !important;
}

.usage-page-layout :deep(.text-green-600),
.usage-page-layout :deep(.dark\:text-green-400) {
  color: #86efac !important;
}

.usage-page-layout :deep(.bg-blue-100),
.usage-page-layout :deep(.bg-amber-100),
.usage-page-layout :deep(.bg-green-100),
.usage-page-layout :deep(.bg-purple-100) {
  background: rgba(34, 197, 94, 0.12) !important;
  border: 1px solid rgba(34, 197, 94, 0.2);
}

.usage-page-layout :deep(.text-blue-600),
.usage-page-layout :deep(.text-amber-600),
.usage-page-layout :deep(.text-purple-600) {
  color: #bbf7d0 !important;
}

.usage-page-layout :deep(.empty-state),
.usage-page-layout :deep(.empty-state-container),
.usage-page-layout :deep(.rounded-lg.border.border-gray-200.bg-white) {
...
.usage-page-layout :deep(.empty-state .bg-gray-100),
.usage-page-layout :deep(.empty-state .dark\:bg-dark-800) {
  border: 1px solid rgba(43, 132, 83, 0.34);
  border-radius: 8px;
  background: rgba(5, 29, 24, 0.72) !important;
  color: rgba(220, 239, 224, 0.58);
}

.usage-page-layout :deep(.empty-state svg),
.usage-page-layout :deep(.empty-state .text-gray-400) {
  color: rgba(134, 239, 172, 0.72) !important;
}

.usage-page-layout :deep(.empty-state-title) {
  color: var(--usage-text) !important;
}

.usage-page-layout :deep(.empty-state-description) {
  color: var(--usage-muted) !important;
}

.usage-page-layout :deep(.bg-gray-50),
.usage-page-layout :deep(.bg-white) {
  background-color: rgba(5, 29, 24, 0.58) !important;
}

.usage-page-layout :deep(.border-gray-200) {
  border-color: rgba(43, 132, 83, 0.32) !important;
}

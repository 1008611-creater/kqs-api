...
=======
  <header class="sticky top-0 z-30 border-b border-primary-900/10 bg-white/88 shadow-[0_1px_0_rgba(0,0,0,0.03)] backdrop-blur-xl dark:border-white/10 dark:bg-[#07140d]/88">
    <div class="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-primary-800 via-primary-600 to-accent-400 dark:via-primary-500"></div>
...
>>>>>>> 1157e4cfe6271a81c9dc96df84af6c6a3b22f831
      ...
      <div class="flex shrink-0 items-center gap-2 sm:gap-4">
        ...
        <div class="hidden lg:block">
          <h1 class="text-lg font-semibold text-primary-950 dark:text-white">
            {{ pageTitle }}
          </h1>
        </div>
      </div>
...
>>>>>>> 1157e4cfe6271a81c9dc96df84af6c6a3b22f831
        ...
        <router-link
          v-if="user"
          to="/guide"
          class="flex items-center gap-1.5 rounded-xl border border-primary-700/15 bg-white/80 px-2.5 py-1.5 text-sm font-semibold text-primary-800 shadow-[inset_0_1px_0_rgba(255,255,255,0.7),0_8px_24px_rgba(0,104,56,0.08)] transition-all hover:-translate-y-0.5 hover:border-primary-700/25 hover:bg-primary-50 hover:text-primary-950 active:translate-y-0 dark:border-white/10 dark:bg-white/8 dark:text-primary-200 dark:hover:bg-white/12 sm:px-3"
        >
...
=======
          class="flex items-center gap-1.5 rounded-xl px-3 py-1.5 text-sm font-medium text-primary-900/65 transition-colors hover:bg-primary-50 hover:text-primary-900 dark:text-white/58 dark:hover:bg-white/8 dark:hover:text-white"
>>>>>>> 1157e4cfe6271a81c9dc96df84af6c6a3b22f831
        >
...
=======
        ...
        <SubscriptionProgressMini v-if="user && USER_SUBSCRIPTIONS_VISIBLE" />
>>>>>>> 1157e4cfe6271a81c9dc96df84af6c6a3b22f831
...
=======
          class="hidden items-center gap-2 rounded-xl border border-primary-900/10 bg-primary-50 px-3 py-1.5 dark:border-white/10 dark:bg-white/6 sm:flex"
>>>>>>> 1157e4cfe6271a81c9dc96df84af6c6a3b22f831
        >
          <svg
...
=======
            class="flex items-center gap-2 rounded-xl p-1.5 transition-colors hover:bg-primary-50 dark:hover:bg-white/8"
            aria-label="User Menu"
>>>>>>> 1157e4cfe6271a81c9dc96df84af6c6a3b22f831
          >
            <div class="flex h-8 w-8 items-center justify-center overflow-hidden rounded-xl bg-gradient-to-br from-primary-500 to-primary-700 text-sm font-medium text-white shadow-sm ring-1 ring-white/40">
              <img
                v-if="avatarUrl"
                :src="avatarUrl"
                :alt="displayName"
          ...
          <transition name="dropdown">
            <div v-if="dropdownOpen" class="dropdown right-0 mt-2 w-56">
              <!-- User Info -->
              <div class="border-b border-primary-900/8 px-4 py-3 dark:border-white/10">
                <div class="text-sm font-medium text-gray-900 dark:text-white">
                  {{ displayName }}
                </div>
              ...
              <!-- Balance (mobile only) -->
              <div class="border-b border-primary-900/8 px-4 py-2 dark:border-white/10 sm:hidden">
                <div class="text-xs text-gray-500 dark:text-dark-400">
                  {{ t('common.balance') }}
                </div>
              ...
              <div class="py-1">
                ...
                <router-link to="/guide" @click="closeDropdown" class="dropdown-item">
              ...
              <div
                v-if="contactInfo"
                class="border-t border-primary-900/8 px-4 py-2.5 dark:border-white/10"
              >
              ...
              <div v-if="showOnboardingButton" class="border-t border-primary-900/8 py-1 dark:border-white/10">
              ...
              <div class="border-t border-primary-900/8 py-1 dark:border-white/10">
                <button
                  @click="handleLogout"

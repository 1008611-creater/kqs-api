...
=======
		...
		MonthlyWindowStart:      sub.MonthlyWindowStart,
		DailyUsageUSD:           sub.DailyUsageUSD,
		DailyRolloverUSD:        sub.DailyRolloverUSD,
		DailyAvailableUSD:       sub.EffectiveDailyAvailableUSD(sub.Group),
		DailyRemainingUSD:       sub.DailyRemainingUSD(sub.Group),
		WeeklyUsageUSD:          sub.WeeklyUsageUSD,
		MonthlyUsageUSD:         sub.MonthlyUsageUSD,
		...
		QuotaBonusMultiplier:    sub.QuotaBonusMultiplier,
		QuotaBonusSource:        sub.QuotaBonusSource,
		CreatedAt:               sub.CreatedAt,
		UpdatedAt:               sub.UpdatedAt,
		User:                    UserFromServiceShallow(sub.User),
		Group:                   GroupFromServiceShallow(sub.Group),

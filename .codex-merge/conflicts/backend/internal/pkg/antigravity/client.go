...
<<<<<<< HEAD
=======
	// smallJSONResponseBodyLimit limits OAuth/account/privacy JSON responses.
	smallJSONResponseBodyLimit int64 = 2 << 20
...
func (c *Client) ExchangeCode(ctx context.Context, code, codeVerifier string) (*TokenResponse, error) {
	...
	bodyBytes, err := readLimitedResponseBody(resp.Body, smallJSONResponseBodyLimit)
	if err != nil {
...
func (c *Client) LoadCodeAssist(ctx context.Context, accessToken string) (*LoadCodeAssistResponse, map[string]any, error) {
	...
	for urlIdx, baseURL := range availableURLs {
		...
		respBodyBytes, err := readLimitedResponseBody(resp.Body, smallJSONResponseBodyLimit)
...
func (c *Client) SetUserSettings(ctx context.Context, accessToken string) (*SetUserSettingsResponse, error) {
	...
	respBody, err := readLimitedResponseBody(resp.Body, smallJSONResponseBodyLimit)
	if err != nil {
		return nil, fmt.Errorf("读取响应失败: %w", err)
	}
